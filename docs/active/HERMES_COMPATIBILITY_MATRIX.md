...
1. The candidate checkout was 2,004 commits behind the existing local `origin/main` ref at H1.1 and 2,010 behind the later local `d2ce2c85` ref at H1.5. This is deliberate pinning, not permission to update during the MVP.
