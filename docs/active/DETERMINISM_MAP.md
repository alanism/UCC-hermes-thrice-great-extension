...
| Diagnosis facts | Deterministic | Rule-derived facts only in MVP. |
| Parent brief data | Deterministic | Structured evidence/interpretation/recommendation sections. |
| Parent brief Markdown | Deterministic | Template render; no model prose in MVP. |
...
| Optional model reasoning | Nondeterministic and out of MVP | Must never govern deterministic facts or approval. |
